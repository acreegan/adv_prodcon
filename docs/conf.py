#!/usr/bin/env python
#
# adv_prodcon documentation build configuration file, created by
...
version = adv_prodcon.__version__
# The full version, including alpha/beta/rc tags.
release = adv_prodcon.__version__
...
htmlhelp_basename = 'adv_prodcondoc'
